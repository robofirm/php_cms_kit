	...
	function get_available_commands() {
		return array(
			array(
				'command' => 'e',
				'description' => 'Encrypt',
				'function' => '\Gigya\CmsStarterKit\GigyaApiHelper::enc',
				'arg_count' => 2,
				'check_args' => false,
			),
			array(
				'command' => 'd',
				'description' => 'Decrypt',
				'function' => '\Gigya\CmsStarterKit\GigyaApiHelper::decrypt',
				'arg_count' => 2,
				'check_args' => false,
			),
			array(
				...
				'function' => '\Gigya\CmsStarterKit\GigyaApiHelper::genKeyFromString',
				'arg_count' => 1,
				'check_args' => true,
			),
			array(
